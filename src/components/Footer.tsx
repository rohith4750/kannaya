...
export default function Footer() {
  return (
    <footer className="h-7 bg-white border-t border-[#cbcbcb] px-5 flex items-center justify-between text-[11px] text-[#4a4a4a] flex-shrink-0 z-10 select-none font-medium">
      ...
      <div className="flex items-center gap-1 text-slate-500 text-[10.5px]">
        <Phone className="w-3 h-3 text-[#6d8196]" />
