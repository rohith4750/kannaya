...
export async function PUT(request: Request) {
  try {
    ...
    const updatePayload: any = {
      ...
      ...(enableWholesale !== undefined && { enableWholesale: !!enableWholesale }),
      ...(termsConditions !== undefined && { termsConditions: termsConditions.trim() }),
      ...(showBankDetails !== undefined && { showBankDetails: !!showBankDetails }),
    ...
    const createPayload: any = {
      ...
      enableWholesale: enableWholesale !== undefined ? !!enableWholesale : false,
      termsConditions: termsConditions?.trim() || 'Goods once sold will not be taken back or exchanged.',
      showBankDetails: showBankDetails !== undefined ? !!showBankDetails : true,
