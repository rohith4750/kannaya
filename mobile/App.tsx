...
const styles = StyleSheet.create({
  ...
  profitBoxVal: { color: '#fff', fontSize: 13, fontWeight: '900', marginTop: 2 },
  ...
  bigValText: { fontSize: 20, fontWeight: '800', color: '#4a4a4a' },
  ...
  cartTotalText: { fontSize: 16, fontWeight: '800', color: '#0f172a', marginVertical: 4 },
  ...
  invAmount: { fontSize: 12, fontWeight: '800', color: '#059669' },
  ...
  navText: { color: '#cbcbcb', fontSize: 11, fontWeight: '500' },
  ...
  modalTotal: { fontSize: 16, fontWeight: 'bold', color: '#0f172a', marginBottom: 16 },
